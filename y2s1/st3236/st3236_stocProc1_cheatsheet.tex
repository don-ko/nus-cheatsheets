...
\footnotesize
\begin{multicols*}{4}
	\input{chapters/1_preReqs.tex}
  \input{chapters/2_markovChains.tex}
  \input{chapters/3_longRunPerf.tex}
  \input{chapters/4_applications.tex}
  \input{chapters/5_poisson.tex}
\end{multicols*}
\end{document}
