...
\footnotesize
\begin{multicols*}{4}
  \input{chapters/0_thms.tex}
	\input{chapters/1_probability.tex}
	\input{chapters/2_estimationMean.tex}
  \input{chapters/3_estimationGeneral.tex}
  % \input{chapters/4_hypothesisTesting.tex}
\end{multicols*}
\end{document}
