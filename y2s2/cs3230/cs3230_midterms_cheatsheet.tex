...
\footnotesize
\begin{multicols*}{4}
  \input{chapters/0_math.tex}
	\input{chapters/1_asymptoticAnalysis.tex}
  \input{chapters/2_recurrences.tex}
  \input{chapters/3_correctness.tex}
  \input{chapters/4_sorting.tex}
  \input{chapters/5_randomisedAlgorithms.tex}
\end{multicols*}
\end{document}
